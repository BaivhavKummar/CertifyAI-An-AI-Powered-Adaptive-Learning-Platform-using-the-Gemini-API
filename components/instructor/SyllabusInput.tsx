...
import { generateQuestionsFromSyllabus } from '../../services/geminiService';
...
const SyllabusInput: React.FC = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const questions = await generateQuestionsFromSyllabus(syllabus, importance, questionRatio, numQuestions);
            ...
            <div className="bg-gray-800 p-6 rounded-lg space-y-6">
                ...
                <div>
                    ...
                    <textarea
                        id="syllabus"
                        rows={10}
                        className="w-full p-3 text-white bg-gray-700 border border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400"
                ...
                <div>
                    <label htmlFor="questionRatio" className="block text-sm font-medium text-gray-300 mb-2">Question Type Preference</label>
                     <select
                        id="questionRatio"
                        className="w-full p-3 text-white bg-gray-700 border border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500"
                        value={questionRatio}
